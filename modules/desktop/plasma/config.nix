{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kwinrc"."Desktops"."Id_1" = "0ac6b481-4359-4633-ba07-744d970873ca";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/0ac6b481-4359-4633-ba07-744d970873ca/04fa79e1-2838-4050-a177-d21d61e60342"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/0ac6b481-4359-4633-ba07-744d970873ca/19900c41-cad0-4663-91f9-b02f83a180db"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/0ac6b481-4359-4633-ba07-744d970873ca/6984d1a5-f82a-48a9-b69b-5677fbed8bea"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/0ac6b481-4359-4633-ba07-744d970873ca/e043865a-abac-4b53-bf88-39dd5061080e"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/140540c6-75f6-5c58-b3d2-69eafc444af1"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/74e4e7f3-1bc0-5669-ade6-790cd8cbcfd4"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/84a18c9f-4c7e-52a0-8556-be8d9c1a9510"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      ...
      "kwinrc"."Tiling/b54ea90a-f660-5608-b3fe-a4a373c721f4"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/e7a69807-95ef-5e29-97e2-4e599221ca8c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/e9169ed0-03d1-5534-9865-7f9b82a9d14d"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
      "kwinrc"."Tiling/f2eb3bcc-ef63-5f98-bf93-6af048d79822"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}x5d}";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///run/media/tiebe/Data/Programming/Kotlin/Otarium/hs_err_pid13216.log";
      "kate/anonymous.katesession"."Document 1".URL = "file:///home/tiebe/Downloads/Book1.csv";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-H-Splitter = "0,1520,0";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 550;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 550;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-2-Splitter = 1520;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 1184;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,548,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 1520;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = "file:///run/media/tiebe/Data/Programming/Kotlin/Otarium/hs_err_pid13216.log";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0".Count = 1;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0".Documents = "file:///run/media/tiebe/Data/Programming/Kotlin/Otarium/hs_err_pid13216.log";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 0" = "file:///run/media/tiebe/Data/Programming/Kotlin/Otarium/hs_err_pid13216.log";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorColumn" = 30;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorLine" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."ScrollLine" = 23245;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 1"."CursorColumn" = 43;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 1"."CursorLine" = 39;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/run\\/media\\/tiebe\\/Data\\/Programming\\/Kotlin\\/Otarium\\/hs_err_pid13216.log"."ScrollLine" = 2247;
